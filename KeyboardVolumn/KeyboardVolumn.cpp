...
// KeyboardVolumn.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CKeyboardVolumnApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// CKeyboardVolumnApp construction

CKeyboardVolumnApp::CKeyboardVolumnApp()
{
...
// The one and only CKeyboardVolumnApp object

CKeyboardVolumnApp theApp;


// CKeyboardVolumnApp initialization
...
BOOL CKeyboardVolumnApp::InitInstance()
{
	...
	if (nResponse == IDOK)
	{
		// TODO: Place code here smto handle when the dialog is
		//  diissed with OK
	}
